...
# map5
gamemap["objects"].append(
    Arc(
        init_pos=[87.5, 237.5, 225, 225],
        start_radian=90,
        end_radian=180,
        passable=False,
        color="black",
