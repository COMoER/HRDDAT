...
model_dir = os.path.join(base_dir,"rl_trainer","models","olympics-running","baseline",f"run{run}","trained_model")
agent = RLAgent(25*25, 36, 1)
actor_net = os.path.join(model_dir,f"actor_{episode}.pth")
